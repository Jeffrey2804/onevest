        ...
        <VStack width={"full"} mt={"50px"} gap={"80px"}>
          ...
          >
            ...
            >
              ...
              >
                <CTAButton
                  action={() => navigate("/search-advisor")}
                  text={"Explore Advisory boards"}
                />
              </HStack>
            </VStack>
            <Box width={"full"}>
        ...
        <VStack width={"full"} gap={20}>
          <Container maxWidth={"60%"}>
            <Text
              ...
              lineHeight={"130%"}
            >
              We've helped 15,000 professionals join an advisory board
            </Text>
          </Container>
      ...
      <FullContainer bg={"#E7F1FF"}>
        ...
        >
          <div className="flex p-4 flex-col justify-center gap-6">
            ...
            <p className="text-xl  text-[#575859]">
              Build, collaborate, and meet with your advisory board all on
              AdvisoryCloud{" "}
            </p>
            <div className="w-sm">
