...
const Form = () => {
  ...
  return (
    <>
      ...
      <button
        type="submit"
        className="bg-blue-600 duration-500 focus:outline-none 
        w-[116px] py-[8px] rounded-[50px] text-white text-[20px] 
        font-semibold border-[1px] border-solid 
        border-blue-600 mt-4 
        hover:text-blue-600 flex flex-row 
